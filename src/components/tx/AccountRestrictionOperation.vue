...
import {
  Deadline, UInt64, OperationRestrictionFlag, TransactionHttp,
...
export default {
  ...
  data () {
    return {
      restrictionType: OperationRestrictionFlag.AllowOutgoingTransactionType,
      restrictionTypes: [
        { type: OperationRestrictionFlag.AllowOutgoingTransactionType, label: 'Allow Outgoing' },
        { type: OperationRestrictionFlag.BlockOutgoingTransactionType, label: 'Block Outgoing' }
      ],
      modificationTypes: [
