...
import {
  Address, Deadline, UInt64, AddressRestrictionFlag, TransactionHttp,
...
export default {
  ...
  data () {
    return {
      restrictionType: AddressRestrictionFlag.AllowIncomingAddress,
      restrictionTypes: [
        { type: AddressRestrictionFlag.AllowIncomingAddress, label: 'Allow Incoming' },
        { type: AddressRestrictionFlag.AllowOutgoingAddress, label: 'Allow Outgoing' },
        { type: AddressRestrictionFlag.BlockIncomingAddress, label: 'Block Incoming' },
        { type: AddressRestrictionFlag.BlockOutgoingAddress, label: 'Block Outgoing' }
      ],
      modificationTypes: [
