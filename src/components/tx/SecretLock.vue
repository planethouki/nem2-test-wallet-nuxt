...
import { Deadline, UInt64, SecretLockTransaction, LockHashAlgorithm, TransactionHttp } from 'symbol-sdk'
...
export default {
  ...
  data () {
    return {
      l_hashType: LockHashAlgorithm.Op_Sha3_256,
      l_hashStrLen: '64',
      l_hashTypes: [
        { type: LockHashAlgorithm.Op_Sha3_256, label: 'Sha3-256', strLen: '64' },
        { type: LockHashAlgorithm.Op_Hash_256, label: 'Hash256', strLen: '64' },
        { type: LockHashAlgorithm.Op_Hash_160, label: 'Hash160', strLen: '40' }
      ],
      l_mosaic: '',
      l_recipient: '',
      l_duration: 240,
